...
namespace SafeAuthenticator
{
    public partial class App : Application
    {
        ...
        public static bool PermissionReqBeforeLogin = false; //bug1 fix
        public static string PermissionReqBeforeLoginUri; //bug1 fix
        ...
        public App()
        {
            ...
            Current.MainPage = new CreateAcctPage();
        }
